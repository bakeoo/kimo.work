...
| # | Alan | Nerede | Kaç yer |
|---|---|---|---|
| [x] | `[şirket unvanı]` → `Ebubekir Taha Karagöz` | 6 sayfanın footer'ı + `iletisim.html` §İşletme bilgileri + `kullanim-kosullari.html` §1/§8/§17 + `gizlilik-politikasi.html` giriş/§13 + `kvkk-aydinlatma-metni.html` §1 | 13 |
